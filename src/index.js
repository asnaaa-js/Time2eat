...
// Fetch and populate category, area, and ingredient dropdowns
async function populateDropdowns() {
  try {
    const [categories, areas, ingredients] = await Promise.all([
      ...
      fetch(ingredientUrl).then(res => res.json())
    ]);
